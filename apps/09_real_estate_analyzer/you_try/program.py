...
def query_data(data):  # list[Purchase]
    ...
    print("The most expensive house is ${:,} with {} beds "
          "and {} baths".format(high_purchase.price, high_purchase.beds,
                                high_purchase.baths))

    # least expensive house?
    low_purchase = data[0]
    print("The least expensive house is ${:,} with {} beds "
          "and {} baths".format(low_purchase.price, low_purchase.beds,
                                low_purchase.baths))
    ...
    print("The average 2-bedroom home is ${:,}, baths={}, sq ft={:,}".format(int(
        ave_price), round(ave_baths, 1), round(ave_sqft, 1)))
